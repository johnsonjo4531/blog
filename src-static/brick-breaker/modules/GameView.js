window.GameView = (function GameView (GameLoop) {
  ...
  function init () {
    ...
    // load some sounds
    AudioPool.addMusic('game', require('../assets/01_A_Night_Of_Dizzy_Spells.mp3'));
    AudioPool.addSFX('paddle_hit', require('../assets/270326__littlerobotsoundfactory__hit-01.wav'));
    AudioPool.addSFX('brick_hit', require('../assets/270325__littlerobotsoundfactory__hit-02.wav'));
    AudioPool.addSFX('game_over', require('../assets/270328__littlerobotsoundfactory__hero-death-00.wav'));
    AudioPool.addSFX('game_win', require('../assets/270333__littlerobotsoundfactory__jingle-win-00.wav'));
